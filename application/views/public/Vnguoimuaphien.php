<link href="{$url}dist/custom/public/css/nguoimuaphien.css" rel="stylesheet">
...
<div id="don-mua" class="container pt-3 pb-3">
	<ul class="nav nav-tabs" id="don-hang-tabs-header" role="tablist">
		...
		<li class="nav-item">
			<a class="nav-link {if $k == 0}active{/if}" id="tab-{$k}" data-toggle="tab" data-tab="tab-{$k}-content" href="{$url}dang-dau-gia#tab-{$k}-content" role="tab" aria-controls="tab-{$k}" aria-selected="false">{$tt}</a>
		</li>
		{/foreach}
	</ul>
	<br>
...
<script src="{$url}dist/custom/public/js/nguoimuaphien.js"></script>

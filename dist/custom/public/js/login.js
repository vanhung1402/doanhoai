jQuery(document).ready(function ($) {
    ...
    $form_login.find('input[type="submit"]').on('click', function (event) {
        event.preventDefault();
        if ($form_login.find('input[name="username"]').val() === '') {
            $form_login.find('input[name="username"]').addClass('has-error').next('span').addClass('is-visible');
            return false;
        } else {
            $form_login.find('input[name="username"]').removeClass('has-error').next('span').removeClass('is-visible');
        }
        if ($form_login.find('input[name="password"]').val() === '') {
            $form_login.find('input[name="password"]').addClass('has-error').closest('.fieldset').find('span').first().addClass('is-visible');
            return false;
        } else {
            $form_login.find('input[name="password"]').removeClass('has-error').closest('.fieldset').find('span').first().removeClass('is-visible');
        }
